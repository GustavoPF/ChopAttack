...
public abstract class CopyOfGameObject {
	...
	public CopyOfGameObject(int x, int y) {
		this.x = x;
		this.y = y;
	}

	public CopyOfGameObject(int x, int y, float color) {
		this.x = x;
		this.y = y;
	...
	public void handleAllCollisions(CopyOfGameObject[] object) {
	...
	public void handleCollisionWith(CopyOfGameObject obj) {
	...
	public boolean hasCollidedWith(CopyOfGameObject obj) {
	...
	public boolean hasCollided(CopyOfGameObject[] object) {
